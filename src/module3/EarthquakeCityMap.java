...
public class EarthquakeCityMap extends PApplet {
	...
	private static final int LARGE_RADIUS = 12;

	private static final int MEDIUM_RADIUS = 8;
	...
	private SimplePointMarker createMarker(PointFeature feature) {
		...
		if (mag < THRESHOLD_LIGHT) {
			...
			marker.setRadius(LIGHT_RADIUS);
		} else if (mag > THRESHOLD_LIGHT && mag < THRESHOLD_MODERATE) {
			marker.setColor(yellow);
			marker.setRadius(MEDIUM_RADIUS);
		} else if (mag > THRESHOLD_MODERATE) {
			marker.setColor(red);
			marker.setRadius(LARGE_RADIUS);
		}
	...
	private void addKey() {
		...
		fill(255, 0, 0);
		ellipse(50, 100, LARGE_RADIUS, LARGE_RADIUS);
		fill(0);
		text("5.0+ Magnitude", 60, 105);
		fill(0);
		text("4.0+ Magnitude", 60, 135);
		fill(255, 255, 0);
		ellipse(50, 130, MEDIUM_RADIUS, MEDIUM_RADIUS);
		fill(0);
		text("Below 4.0", 60, 165);
		fill(0, 0, 255);
		ellipse(50, 160, LIGHT_RADIUS, LIGHT_RADIUS);
	}
}
