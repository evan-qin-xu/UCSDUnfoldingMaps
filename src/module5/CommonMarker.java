...
public abstract class CommonMarker extends SimplePointMarker {
	...
	public void draw(PGraphics pg, float x, float y) {
		...
		if (!hidden) {
			// TODO debug why city marker cannot be selected
			drawMarker(pg, x, y);
			if (selected) {
	...
	@Override
	public boolean isInside(UnfoldingMap map, float mouseX, float mouseY) {
		return super.isInside(map, mouseX, mouseY);
	}
